import { ActiveGesturesRegistry } from "@mui/x-internal-gestures/core/ActiveGesturesRegistry.js";
import { Gesture, GestureEventData, GestureOptions, type BaseGestureOptions } from "@mui/x-internal-gestures/core/Gesture.js";
import type { KeyboardManager } from "@mui/x-internal-gestures/core/KeyboardManager.js";
import { PointerData, PointerManager } from "@mui/x-internal-gestures/core/PointerManager.js";
import { TargetElement } from "@mui/x-internal-gestures/core/types/TargetElement.js";
/**
...
export declare abstract class PointerGesture<GestureName extends string> extends Gesture<GestureName> {
  ...
  protected getBaseConfig(): {
    requiredKeys: import("@mui/x-internal-gestures/core/KeyboardManager.js").KeyboardKey[];
    minPointers: number;
    maxPointers: number;
  };
