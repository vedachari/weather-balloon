import type { ChartPluginSignature } from "@mui/x-charts/internals/plugins/models/index.js";
import type { ChartSeriesType, DatasetType } from "@mui/x-charts/models/seriesType/config.js";
import type { ComputedAxis, ScaleName, AxisId, ChartsAxisData, YAxis, XAxis, DefaultedXAxis, DefaultedYAxis, AxisItemIdentifier } from "@mui/x-charts/models/axis.js";
import type { UseChartSeriesSignature } from "@mui/x-charts/internals/plugins/corePlugins/useChartSeries/index.js";
import type { ZoomData, ZoomOptions, ZoomSliderShowTooltip } from "@mui/x-charts/internals/plugins/featurePlugins/useChartCartesianAxis/zoom.types.js";
import type { UseChartInteractionSignature } from "@mui/x-charts/internals/plugins/featurePlugins/useChartInteraction/index.js";
import type { ChartsAxisProps } from "@mui/x-charts/ChartsAxis/index.js";
/**
