import { AxisId, ChartsRadiusAxisProps, ChartsRotationAxisProps, PolarAxisDefaultized, ScaleName, type AxisScaleConfig, type ChartsXAxisProps, type ChartsYAxisProps, type ComputedAxis } from "@mui/x-charts/models/axis.js";
/**
 * Get all the x-axes.
 *
...
export declare function useXAxes(): {
  xAxis: import("@mui/x-charts/internals/index.js").ComputedAxisConfig<ChartsXAxisProps>;
  xAxisIds: AxisId[];
};
/**
 * Get all the y-axes.
...
export declare function useYAxes(): {
  yAxis: import("@mui/x-charts/internals/index.js").ComputedAxisConfig<ChartsYAxisProps>;
  yAxisIds: AxisId[];
};
/**
 * Get the X axis.
...
export declare function useRotationAxes(): {
  rotationAxis: import("@mui/x-charts/internals/plugins/featurePlugins/useChartPolarAxis/computeAxisValue.js").DefaultizedAxisConfig<ChartsRotationAxisProps>;
  rotationAxisIds: string[];
};
export declare function useRadiusAxes(): {
  radiusAxis: import("@mui/x-charts/internals/plugins/featurePlugins/useChartPolarAxis/computeAxisValue.js").DefaultizedAxisConfig<ChartsRadiusAxisProps>;
