import type { ChartItemIdentifierWithData, ChartSeriesDefaultized, ChartSeriesType, ChartsSeriesConfig } from "@mui/x-charts/models/seriesType/config.js";
import { SeriesId } from "@mui/x-charts/models/seriesType/common.js";
import { AxisId, ChartsRotationAxisProps, ChartsRadiusAxisProps, PolarAxisDefaultized, ComputedXAxis, ComputedYAxis } from "@mui/x-charts/models/axis.js";
import { ChartsLabelMarkProps } from "@mui/x-charts/ChartsLabel/ChartsLabelMark.js";
import { ColorGetter } from "@mui/x-charts/internals/plugins/models/seriesConfig/colorProcessor.types.js";
